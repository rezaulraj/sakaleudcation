          ...
          <div className="col-span-1 flex flex-col items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                target="_blank"
              >
                <FaInstagram className="bg-zinc-600 size-8 p-1 rounded-md text-white hover:bg-red-600 hover:-translate-y-1 transition-transform duration-300 cursor-pointer" />
              </a>
              <a
                href="https://www.facebook.com/aladdingroup.online"
                target="_blank"
              >
                <FaFacebook className="bg-zinc-600 size-8 p-1 rounded-md text-white hover:bg-red-600 hover:-translate-y-1 transition-transform duration-300 cursor-pointer" />
              </a>
              <a
                href="https://www.youtube.com/@AladdinGroupLimited"
                target="_blank"
              >
                <FaYoutube className="bg-zinc-600 size-8 p-1 rounded-md text-white hover:bg-red-600 hover:-translate-y-1 transition-transform duration-300 cursor-pointer" />
              </a>
              <a
                href="https://www.linkedin.com/company/aladdin-group-limited"
                target="_blank"
              >
                <FaLinkedin className="bg-zinc-600 size-8 p-1 rounded-md text-white hover:bg-red-600 hover:-translate-y-1 transition-transform duration-300 cursor-pointer" />
              </a>
              <a href="https://twitter.com/GroupAladdinLt" target="_blank">
                <FaTwitter className="bg-zinc-600 size-8 p-1 rounded-md text-white hover:bg-bg-red-600 hover:-translate-y-1 transition-transform duration-300 cursor-pointer" />
              </a>
              <a
                href="https://www.pinterest.com/aladdingrouplimited"
                target="_blank"
              >
                <FaPinterest className="bg-zinc-600 size-8 p-1 rounded-md text-white hover:bg-red-600 hover:-translate-y-1 transition-transform duration-300 cursor-pointer" />
              </a>
            </div>
          </div>
